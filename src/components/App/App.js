  ...
  return (
    <div className="App">
      ...
      {!instructionsHidden && <h2>
        ...
        green square. <br></br> A yellow "D" on letter 2 should be placed in the
        yellow box second from the left. <br></br>
        Enter all black letters in any order. <br></br>
        No commas between letters. <br></br> One letter per green input, as many
        in other inputs as needed.
      </h2>}
      <button
        id="hide"
        onClick={(e) => {
